...
<div class="container">
 ...
 <div class="p-5 mb-4 bg-body-tertiary rounded-3">
	...
	<c:set var="mail" value="${row.m_email}" />
	<c:set var="mail1" value="${mail.split('@')[0]}" />
	<c:set var="mail2" value="${mail.split('@')[1]}" />

	<c:set var="birth" value="${row.m_date }" />
	...
	<div class="container">
		<form name="newMember"action="processUpdateMember.jsp" method="post" onsubmit="return checkForm()">
				...
				<div class="col-sm-3">
					<input name="m_id" type="text" class="form-control" placeholder="id" value="<c:out value='${row.m_id }'/>" >
				</div>
			</div>
				<div class="mb-3 row">
				...
				<div class="col-sm-3">
					<input name="m_password_confirm" type="password" class="form-control" placeholder="password_confirm" >
				</div>
			</div>
				<div class="mb-3 row">
